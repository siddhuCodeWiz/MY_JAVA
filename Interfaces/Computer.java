...
public class Computer extends Electronic implements BluetoothInterface, Hotspot, SecondHotspot {
    ...
    public Computer(String brand, int storage, int ram) {
        ...
        this.storage = storage;
        this.ram = ram;
        // Hotspot.noOfDevices = 10;  Cannot so this as it a static final variable
        // But as the password var is static we call it using class reference
        System.out.println(Hotspot.noOfDevices);
    ...
    public static void main(String[] args) {
        Computer cm = new Computer("Dell", 512, 16);

        cm.displaySpecs();
        cm.powerOn();
        cm.enableBluetooth();
        BluetoothInterface b = new Computer("HP", 512, 32);
